...
Arduino sketch for a standard ESP32 + Adafruit 0.56" 4-digit 7-segment backpack display (product 881) to read Watts Bar Lake elevation from this repository's `data.json` and display it.
